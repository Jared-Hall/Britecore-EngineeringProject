...
application.config.update(dict(
	SQLALCHEMY_DATABASE_URI='mysql+pymysql://Jared007:Smspass1@sms-db.ccapjqufkw2l.us-west-2.rds.amazonaws.com:3306/sms_db',
...
def features(method):
	...
	try:
		...
		if(request.method == 'GET'):
			...
			response = database.session.query(Features).filter_by(sys_id=data['system'], feat_title=data['feature']).delete()
